(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (e.target.closest(".icon-menu")) {
                ...
                document.querySelector(".contact").classList.toggle("open-aside");
                document.querySelector(".header__tel").classList.toggle("hide");
            }
        }));
    }
    ...
    function initSliders() {
        if (document.querySelector(".swiper-hero") || document.querySelector(".swiper-productions")) new swiper_core_Swiper(".swiper-hero", {
            ...
            on: {
                slideChangeTransitionStart: function() {
                    const slideShadow = document.querySelectorAll(".swiper-slide-shadow");
                    slideShadow.forEach((slide => {
    ...
    new swiper_core_Swiper(".swiper-productions", {
        breakpoints: {
            1: {
                slidesPerView: 4,
                centeredSlides: true,
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        const links = document.querySelectorAll(".header__menu .header__item .header__link");
        const moblinks = document.querySelectorAll(".contact__menu .contact__item .contact__link");
        for (const link of links) link.addEventListener("click", clickHandler);
        for (const link of moblinks) link.addEventListener("click", clickHandler);
    ...
    function delayJs() {
        ...
        if (mediaQuery992.matches) {
            const marquee1 = document.querySelector(".runline1");
            const marquee2 = document.querySelector(".runline2");
            let windowWidth = window.innerWidth;
            window.addEventListener("resize", (() => {
                windowWidth = window.innerWidth;
            }));
            function checkMarqueeAnimation() {
                const marqueeWidth1 = marquee1.offsetWidth;
                const marqueeWidth2 = marquee2.offsetWidth;
                if (marqueeWidth1 > windowWidth) marquee1.style.animationPlayState = "running"; else marquee1.style.animationPlayState = "paused";
                if (marqueeWidth2 > windowWidth) marquee2.style.animationPlayState = "running"; else marquee2.style.animationPlayState = "paused";
            }
            setTimeout((function() {
                window.addEventListener("load", checkMarqueeAnimation);
                window.addEventListener("resize", checkMarqueeAnimation);
            }), 0);
        }
    }
    setTimeout(delayJs, 500);
    window["FLS"] = true;
    isWebp();
    menuInit();
})();